$(function() {
    function loadshit(responseData) {
        ...
        $(".email a").attr('href', responseData.email + "?subject=Data Retention and Investigatory Powers Bill&body= Dear " + responseData.mpName + ", %0D%0A %0D%0A I am writing because I am greatly concerned about the Data Retention and Investigatory Powers Bill that is being rushed through parliament by all parties. I think this shows gross disregard for the political process. I consider this a very serious issue and I think it should at least be discussed in parliament before a decision is reached. %0D%0A %0D%0A I hope that you will consider the constituents that elected you before voting on this bill. The website I have used to contact you today will inform me of how you vote on this this bill, remember you work for us. ")
